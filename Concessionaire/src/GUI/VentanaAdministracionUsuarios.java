...
public class VentanaAdministracionUsuarios extends JInternalFrame implements ActionListener {
    ...
    public VentanaAdministracionUsuarios() {
        super("Administrar Usuarios", false, true, false);
    ...
    private void configurarBusqueda() {
        ...
        jcbCriterioBusqueda = new JComboBox(new String[] {"Identificación", "Nombre", "Cargo", "Estado Civil", "Ciudad"});
